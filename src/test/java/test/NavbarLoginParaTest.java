...
public class NavbarLoginParaTest {
	...
	public NavbarLoginParaTest(String expected, int rowNum) {
	...
	@Test
	public void navbarLoginNavAttempt() throws IOException, InterruptedException {
		...
		NavbarResult loginResult = PageFactory.initElements(driver, NavbarResult.class);
		...
		cell.setCellValue(loginResult.loginNavResultText());

		try {
			assertEquals("Test failure.", expected, loginResult.loginNavResultText());
			cell = row.getCell(2);
			if (cell == null) {
