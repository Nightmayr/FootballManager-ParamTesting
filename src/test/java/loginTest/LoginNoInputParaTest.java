...
import loginSetup.LoginEntry;
import loginSetup.LoginResult;
...
public class LoginNoInputParaTest {
	...
	public static Collection<Object[]> inputData() throws IOException {
		FileInputStream file = new FileInputStream(Constant.LOGIN_LOCATION);
	...
	public LoginNoInputParaTest(String expected, int rowNum) {
	...
	public void loginAttempt() throws IOException, InterruptedException {
		...
		try {
			...
			FileOutputStream fileOut = new FileOutputStream(Constant.LOGIN_LOCATION);
