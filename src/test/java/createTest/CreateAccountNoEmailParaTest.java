...
import createAccountSetup.CreateAccountEntry;
import createAccountSetup.CreateAccountResult;

@RunWith(Parameterized.class)
public class CreateAccountNoEmailParaTest {

	@Parameters
	public static Collection<Object[]> inputData() throws IOException {
		FileInputStream file = new FileInputStream(Constant.CREATE_LOCATION);
	...
	public CreateAccountNoEmailParaTest(String fullName, String password, String confirmPassword, String expected,
			int rowNum) {
	...
	public void addAccountAttempt() throws IOException, InterruptedException {
		...
		addAccountPage.addAccountNoEmail(fullName, password, confirmPassword);
		...
		try {
			...
			FileOutputStream fileOut = new FileOutputStream(Constant.CREATE_LOCATION);
