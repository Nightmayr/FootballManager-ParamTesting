...
public class CreateAccountNoPassParaTest {
	...
	public CreateAccountNoPassParaTest(String fullName, String email, String confirmPassword, String expected,
			int rowNum) {
	...
	public void addAccountAttempt() throws IOException, InterruptedException {
		...
		addAccountPage.addAccountNoPassword(fullName, email, confirmPassword);
