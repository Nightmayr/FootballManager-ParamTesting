...
import joinSetup.JoinEntry;
import joinSetup.JoinResult;

@RunWith(Parameterized.class)
public class LeaveListParametisedTest {
	
	@Parameters
	public static Collection<Object[]> inputData() throws IOException {
		FileInputStream file = new FileInputStream(Constant.LIST_LOCATION);
	...
	public LeaveListParametisedTest(String fullName, String email, String password, String confirmPassword,
	...
	public void addAccountAttempt() throws IOException, InterruptedException {
		...
		try {
			...
			FileOutputStream fileOut = new FileOutputStream(Constant.LIST_LOCATION);
