...
public class CreateAccountNoNameParaTest {
	...
	public static Collection<Object[]> inputData() throws IOException {
		...
		Object[][] obj = new Object[sheet.getPhysicalNumberOfRows()-1][];
	...
	public CreateAccountNoNameParaTest(String email, String password, String confirmPassword, String expected, int rowNum) {
		this.email = email;
